...
namespace HangMan
{
    class Program
    {
        ...
        {
            string playerName = "";
            string[] wordsContainer = new string[] { "Apple", "Orange", "Pineaplle", "Lemon", "Apricot", "Banana", "Coconut", "Durian", "Guava", "Mango", "Lychee"};
            string word = "";
            ...
            Console.WriteLine("Debugging info: "+ word); //for debug
            //string wordHidden = "";
